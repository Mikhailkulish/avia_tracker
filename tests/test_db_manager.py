...
class TestDBManager:
    ...
    def test_init_success(self, mock_logger_db_manager, mock_psycopg2_db_manager):
        mock_conn = Mock()
    ...
    def test_init_error(self, mock_logger_db_manager, mock_psycopg2_db_manager):
    ...
    def test_close(self, mock_logger_db_manager):
        mock_conn = Mock()
        db = DBManager()
    ...
    def test_get_countries_and_aeroplanes_count(self, mock_logger_db_manager):
        mock_conn = Mock()
        mock_cur = Mock()
    ...
    def test_get_all_aeroplanes(self, mock_logger_db_manager):
        mock_conn = Mock()
        mock_cur = Mock()
    ...
    def test_get_avg_speed(self, mock_logger_db_manager):
        mock_conn = Mock()
        mock_cur = Mock()
    ...
    def test_get_aeroplanes_with_higher_speed(self, mock_logger_db_manager):
        mock_conn = Mock()
        mock_cur = Mock()
    ...
    def test_get_aeroplanes_with_keyword(self, mock_logger_db_manager):
        mock_conn = Mock()
        mock_cur = Mock()
    ...
    def test_get_aeroplanes_by_country(self, mock_logger_db_manager):
        mock_conn = Mock()
        mock_cur = Mock()
    ...
    def test_get_statistics_summary(self, mock_logger_db_manager):
        mock_conn = Mock()
        mock_cur = Mock()
